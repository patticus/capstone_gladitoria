...
export function oppGetHurt() {
  ...
  setTimeout(() => {
    element.classList.remove("opp-hurt-anim");
  }, 500);
}
...
export function dodgeShake() {
  ...
  setTimeout(() => {
    element.classList.remove("dodge-anim");
  }, 500);
}
...
export function oppAttackAnimation() {
  ...
  setTimeout(() => {
    element.classList.remove("opp-attack-anim");
  }, 500);
}
...
export function displayDmgNumber(dmg, styleClass) {
  ...
  setTimeout(() => {
    dmgNumber.parentNode.removeChild(dmgNumber);
  }, 1400);
}
...
export function animatePlayerAttack(gladName) {
  ...
  setTimeout(() => {
    attackFrame.src = require(`../assets/images/weapons-${gladName}.png`);
    attackFrame.style.zIndex = "0";
  }, 350);
}
...
export function fadeToArena() {
  ...
  setTimeout(() => {
    stagingBG.classList.add("staging-bg-fade");
  }, 950);
  setTimeout(() => {
...
export const insultsPep = ["WAAAAAH!", "<i>growl</i>", "<i>hissss</i>"];
